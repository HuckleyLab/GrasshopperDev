...
ggplot(data = all_f, aes(x =Temperature)) + facet_grid(.~Site) + geom_point(aes(y = Age_Adult, color="Age_Adult")) + geom_point(aes(y=fit, color="black"))
```
```{r}
...
ggplot(data = all_m, aes(x =Temperature)) + facet_grid(.~Site) + geom_point(aes(y = Age_Adult, color="Age_Adult")) + geom_point(aes(y=fit, color="black"))
```
