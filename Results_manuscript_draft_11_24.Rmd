...
```
Mean preferred body temperature of lab-reared male and female (rows) grasshoppers whose mothers came from different sites (y-axis). Photoperiod (columns) and temperature variance (rows) were varied. The numbers represent sample sizes.
...
None of the main effects were significant. There are arguably trends towards low temperature variance and long photoperiod decreasing preferred temperature ($\chi$^2^~1~=3.049, p=.0808; $\chi$^2^~1~=3.120, p=.0773, Table 4)
...
### CTmin and CTmax
[There was an issue stopping it from running... coming later]
<!-- CTmin (will reformat) -->
<!-- ```{r} -->
<!-- #CT -->
